      ...
      <SheetContent side="left">
        ...
        <div class="w-full h-full overflow-y-auto">
            <div class="flex flex-col space-y-2">
                <Button @click="clickCategory()" class="p-2 active:scale-95 bg-[var(--orange)] space-x-3 rounded-sm shadow-md flex items-center justify-center">
                ...
                <button @click="clickItems('register')" class="p-2 active:scale-95 bg-[var(--orange)] space-x-3 rounded-sm shadow-md flex items-center justify-center">
                  ...
                  <div class="w-full">
                    <span class="uppercase font-semibold"> Cadastro</span>
                  </div>   
                </button>
